...
func (mc *MaterialsClient) SearchMaterial(ctx context.Context, param domain.MaterialParams) ([]domain.Material, error) {
	var mtrls []domain.Material
...
func (mc *MaterialsClient) CreateMaterialCategory(ctx context.Context, category domain.MaterialCategory) (int64, error) {
...
func (mc *MaterialsClient) GetByIdMaterialCategory(ctx context.Context, id, companyId int64) (domain.MaterialCategory, error) {
	if id <= 0 {
		return domain.MaterialCategory{}, errors.New("material category, grpc client - invalid id")
	}
	...
	return domain.MaterialCategory{
		ID:          resp.Id,
		Name:        resp.Name,
		CompanyID:   resp.CompanyId,
...
func (mc *MaterialsClient) UpdateMaterialCategory(ctx context.Context, category domain.MaterialCategory) error {
...
func (mc *MaterialsClient) GetListMaterialCategory(ctx context.Context, param domain.MaterialParams) ([]domain.MaterialCategory, error) {
	...
	for _, c := range resp.MaterialCategories {
		categories = append(categories, domain.MaterialCategory{
			ID:          c.Id,
			Name:        c.Name,
...
func (mc *MaterialsClient) SearchMaterialCategory(ctx context.Context, param domain.MaterialParams) ([]domain.MaterialCategory, error) {
	var categories []domain.MaterialCategory
